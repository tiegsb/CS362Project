...
void adventurerCardEffect(int currentPlayer, struct gameState *state){
    ...
    printf("AdventurerCardEffectFunction Called\n");
    ...
    while(drawntreasure<2){
        ...
        drawCard(currentPlayer, state);
        printf("Card drawn. Placing into hand...\n");
    ...
    printf("Draw loop completed. Discarding temp hand...\n");
    ...
    printf("Temp hand discarded. Returning ...\n");
