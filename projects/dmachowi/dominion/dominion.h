...
/* Plays adventurer card, choses cards until player gets two treasures */

void playSmithy(struct gameState *state, int handPos);
/* Plays smithy card, allows the player to draw 3 more cards */

void playCouncil_Room(struct gameState *state, int handPos);
/* Plays council card, allows the user to draw four more cards and add one buy*/

void playFeast(struct gameState *state, int choice1);
/* Plays feast card, allows the user to trash the current feast card and choose
    any card costing up to 5 */

void playRemodel(struct gameState *state, int handPos, int choice1, int choice2);
/* Plays remodel, allows the user to trash one card and get one that costs up to 2 more */
