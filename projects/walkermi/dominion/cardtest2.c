...
int main(int argc, const char * argv[]) {
    ...
    for (player = 0; player < numPlayer; ++player) {
        ...
        for (handCount = 1; handCount <= maxHandCount; ++handCount) {
            ...
            // set last card in current player's hand to Smithy Card
...
// END Test 4: If All Cards Are Drawn From Deck Before Smithy Card Resolves, Discard Pile is Added to Deck
            ...
            state.hand[player][handCount - 1] = smithy;
...
// END Test 5: Game State Is Not Altered Other Than Current Player's Hand & Count, Deck & Count, and PLayed Pile
    ...
    if (errors == 0)
        printf ("TESTING OF Smithy Card COMPLETED SUCCESSFULLY\n");
    else
        printf ("TESTING OF Smithy Card COMPLETED WITH ERRORS\n");
    return 0;
}
