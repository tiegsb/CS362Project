...
int main(int argc, const char * argv[]) {
    ...
    for (player = 0; player < numPlayer; ++player) {
        ...
        for (handCount = 1; handCount <= maxHandCount; ++handCount) {
            ...
            // set last card in current player's hand to Great Hall Card
...
// BEG Test 1: Great Hall is Discarded From Hand to Played Pile
#if (NOISY_TEST == 1)
            printf("Test 1: Great Hall is Discarded From Hand to Played Pile\n");
#endif
            
#if (NOISY_TEST == 1)
            printf("Expected: Great Hall Card Not In Hand\n");
#endif
            tracker = 0;
            ...
            if (tracker != 0) {
                printf("ERROR: Great Hall Card Still In Hand\n");
                errors++;
            }
            
#if (NOISY_TEST == 1)
            if (tracker == 0)
                printf("Actual: Great Hall Card Not In Hand\n");
#endif
            
            
#if (NOISY_TEST == 1)
            printf("Expected: Great Hall Card in Played Pile\n");
#endif
            tracker = 0;
            ...
            if (tracker == 0) {
                printf("ERROR: Great Hall Card Not In Played Pile\n");
                errors++;
            }
            
#if (NOISY_TEST == 1)
            if (tracker != 0)
                printf("Actual: Great Hall Card in Played Pile\n");
#endif
// END Test 1: Great Hall is Discarded From Hand to Played Pile
...
// BEG Test 4: Current Player's Actions Are Increased By One
#if (NOISY_TEST == 1)
            printf("Test 4: Current Player's Actions Are Increased By One\n");
#endif
            
#if (NOISY_TEST == 1)
            printf("Expected Num Actions: %i, Actual Num Actions: %i\n", preState.numActions + 1, state.numActions);
#endif
            assert(preState.numActions + 1 == state.numActions);
// END Test 4: Current Player's Actions Are Increased By One
            
            
            
// BEG Test 5: If Deck is Empty When Great Hall Card is Played, Discard Pile is Added to Deck
#if (NOISY_TEST == 1)
            printf("Test 5: If Deck is Empty When Great Hall Card is Played, Discard Pile is Added to Deck\n");
#endif
            ...
            state.hand[player][handCount - 1] = great_hall;
...
#endif
            assert(tracker == 1);
// END Test 5: If Deck is Empty When Great Hall Card is Played, Discard Pile is Added to Deck
...
// END Test 6: Game State Is Not Altered Other Than Current Player's Hand & Count, Deck & Count, Actions, and Played Pile
    ...
    if (errors == 0)
        printf ("TESTING OF Great Hall Card COMPLETED SUCCESSFULLY\n");
    else
        printf ("TESTING OF Great Hall Card COMPLETED WITH ERRORS\n");
    return 0;
}
