...
//case: deckCount current player < 1
  printf("Check condition deckCount of current player < 1:\n");
  createRandState(&testerState);
  testerState.handCount[testerState.whoseTurn]= rand() % 13 +1;
  testerState.deckCount[testerState.whoseTurn]= 0;
  unittest2(&testerState);

//case: cardDrawn = copper
  printf("Check condition cardDrawn is copper:\n");
  createRandState(&testerState);
  testerState.handCount[testerState.whoseTurn]= rand() % 13 +1;
  testerState.hand[testerState.whoseTurn][testerState.handCount[testerState.whoseTurn]-1]= copper;
  unittest2(&testerState);
  
//case: cardDrawn = silver
  printf("Check condition cardDrawn is silver:\n");
  createRandState(&testerState);
  testerState.handCount[testerState.whoseTurn]= rand() % 13 +1;
  testerState.hand[testerState.whoseTurn][testerState.handCount[testerState.whoseTurn]-1]= silver;
  unittest2(&testerState);

//case: cardDrawn = gold
  printf("Check condition cardDrawn is gold:\n");
  createRandState(&testerState);
  testerState.handCount[testerState.whoseTurn]= rand() % 13 +1;
  testerState.hand[testerState.whoseTurn][testerState.handCount[testerState.whoseTurn]-1]= gold;
  unittest2(&testerState);

//case: cardDrawn = non treasure card
  printf("Check condition cardDrawn is not treasure\n");
  createRandState(&testerState);
  testerState.handCount[testerState.whoseTurn]= rand() % 13 +1;
  testerState.hand[testerState.whoseTurn][testerState.handCount[testerState.whoseTurn]-1]= province;
  unittest2(&testerState);
