...
int council_room_ref(struct gameState* state, int currentPlayer, int i )
{
      //+4 Cards
      for (i = 0; i < 4; i++)
	{
...
int smithy_ref(struct gameState* state, int currentPlayer, int handPos, int i )
{
      //+3 Cards
      for (i = 1; i < 3; i++)
	{
