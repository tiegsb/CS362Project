...
village card:
	...
	on the assumption the component funcitons are workign properly.
...
unittest2:
	...
	number of times. We do have strong statement coverage.

unittest3:
	scoreFor() function
	here we have full statement coverage with 86% branch coverage. We could have easily added more
	cards of varying values to get fuller coverage. 
