...
int main(){
	...
	int deck1[5] = {silver, province, council_room, gold, copper};
	int deck2[5] = {gold, silver, smithy, gold, gardens};
	int deck1Copy[5];
	int deck2Copy[5];
	struct gameState G;
	...
	printf( "Deck 2 has %d cards in a different position, not shuffled\n", deck2Shuffle);
