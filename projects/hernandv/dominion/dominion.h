...
/* Play village card and update game with card effects */
...
void outpostCard(struct gameState* state, int hanPos, int currentPlayer);
/* Play Outpost card and update game with card effects */
