...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
        mining(currentPlayer, state, choice1, choice2, handPos);
      		
    case remodel:
        remod(currentPlayer, state, choice1, choice2, handPos);
		
    case smithy:
         smith(currentPlayer, state, handPos);
...
int adven(int currentPlayer, struct gameState *state){
...
int mining(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos){
...
int remod(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos){ 
    int j;
    int i;
    j = state->hand[currentPlayer][choice1];  //store card we will trash
