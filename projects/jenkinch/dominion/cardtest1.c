/* -----------------------------------------------------------------------
 * cardtest1.c
 * Test of cardEffect(smithy) in dominion.c
 * -----------------------------------------------------------------------
 */
...
int testCardEffect(int card) {
    ...
    int p0Hand[MAX_HAND] = {sea_hag, copper, copper, copper, smithy};
    ...
    if(cardEffect(smithy, 0, 0, 0, &G, 4, 0) == 0)
        printf("cardEffect(smithy): PASS player 0, function returned successfully \n");
    else
        printf("cardEffect(smithy): FAIL player 0, function returned successfully \n");
    
    //Test for updated handCount - player 0
    if(G.handCount[0] == p0HandCount - 1 + 3)
        printf("cardEffect(smithy): PASS player 0, handCount correct after discard/draw \n");
    else
        printf("cardEffect(smithy): FAIL player 0, handCount correct after discard/draw \n");
    
    //Test for updated discardCount - player 0
    if(G.discardCount[0] == p0DiscardCount + 1)
        printf("cardEffect(smithy): PASS player 0, discardCount correct after discard \n");
    else
        printf("cardEffect(smithy): FAIL player 0, discardCount correct after discard \n");
    
    //Test for updated deckCount - player 0
    if(G.deckCount[0] == p0DeckCount - 3)
        printf("cardEffect(smithy): PASS player 0, deckCount correct after draw \n");
    else
        printf("cardEffect(smithy): FAIL player 0, deckCount correct after draw \n");
    
    //Test for unaffected handCount - player 1
    if(G.handCount[1] == p1HandCount)
        printf("cardEffect(smithy): PASS player 1, handCount unaffected after p0 discard/draw \n");
    else
        printf("cardEffect(smithy): FAIL player 1, handCount unaffected after p0 discard/draw \n");
    
    //Test for unaffected discardCount - player 1
    if(G.discardCount[1] == p1DiscardCount)
        printf("cardEffect(smithy): PASS player 1, discardCount unaffected after p0 discard \n");
    else
        printf("cardEffect(smithy): FAIL player 1, discardCount unaffected after p0 discard \n");
    
    //Test for unaffected deckCount - player 1
    if(G.deckCount[1] == p1DeckCount)
        printf("cardEffect(smithy): PASS player 1, deckCount unaffected after p0 draw \n");
    else
        printf("cardEffect(smithy): FAIL player 1, deckCount unaffected after p0 draw \n");
