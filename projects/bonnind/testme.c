 ...
 * testme.c
 *
 * This file contains an implementation of inputChar() and inputString(), by
 * Daniel Bonnin as part of the requirements of Random Testing Quiz 2.
 *
 * testme.c can be compiled with the following commands:
 * $ gcc -o testme testme.c -Wall
 * $ ./testme
 */
